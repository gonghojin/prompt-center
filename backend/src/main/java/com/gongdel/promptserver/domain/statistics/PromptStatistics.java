...
/**
 * 프롬프트 통계 정보를 담는 도메인 객체입니다.
 * <p>
 * 총 프롬프트 개수, 비교 기간, 비교 결과를 포함합니다.
 */
@Getter
@Builder
@Slf4j
public class PromptStatistics {
    ...
    /**
     * PromptStatistics 객체를 생성합니다.
     *
     * @param totalCount       총 프롬프트 개수 (0 이상)
     ...
     */
    public PromptStatistics(long totalCount, ComparisonPeriod comparisonPeriod, ComparisonResult comparisonResult) {
        ...
        log.debug("PromptStatistics created: totalCount={}, period={}, result={}", totalCount, comparisonPeriod,
            comparisonResult);
    }
}
